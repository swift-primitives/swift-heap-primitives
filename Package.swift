...
let package = Package(
    ...
    dependencies: [
        ...
        // unifies on identity swift-memory-primitives--w2 (no url-form memory in the
    ...
    targets: [
        ...
        .target(
            ...
            dependencies: [
                ...
                .product(name: "Index Primitives", package: "swift-index-primitives"),
                .product(name: "Buffer Linear Primitive", package: "swift-buffer-linear-primitives--w2"),
                .product(name: "Buffer Linear Inline Primitive", package: "swift-buffer-linear-primitives--w2"),
