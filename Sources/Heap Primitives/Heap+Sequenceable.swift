...
// (Heap+Sequenceable.swift) per [MOD-036] refined-C; this conformance is thin.
//
// `Heap` does not conform to `Swift.Sequence`: the span-primitive iteration
...
extension Heap: Sequenceable where Element: Copyable {
