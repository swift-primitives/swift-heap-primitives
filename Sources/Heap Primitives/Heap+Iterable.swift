...
// binding to the sibling Heap+Sequenceable.swift. `forEach` is inherited from the
// Iterable floor. Elements are yielded in heap order, NOT sorted order.

extension Heap: Iterable where Element: ~Copyable {
